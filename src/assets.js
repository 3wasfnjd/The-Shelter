// Deliberate empty asset slots. Never substitute runtime primitive environment art.
// Geometry, UVs, material palette and pivots are supplied by the artist in these GLBs.
...
export const ASSET_SLOTS = [
  ...
  { id: 'player', file: 'bunker-technician.glb', position: [0,0,3.8], nodes: [], animations: ['Idle','Walk'], description: 'Original 1.7 m stylized technician facing +Z, skinned with Idle/Walk clips, feet at origin' },
];
