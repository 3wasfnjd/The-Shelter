...
export const ASSET_SLOTS = [
  ...
  { id: 'power', file: 'power-station.glb', position: [-3.5,0,2.5], rotation: Math.PI/2, nodes: [...sequence('Module_',6),...sequence('Trace_',6),'PowerIndicator','GeneratorRotor','PowerCabinet','SourceBattery','SourceLead','OutputLead','OutputBulb'], collider: [-.55,-.95,.55,.95], description: 'Generator, distribution board, six port-bearing circuit modules (3 columns × 2 rows), input/output labels, wiring, breakers' },
  ...
  { id: 'workbench', file: 'workbench.glb', position: [-1.3,0,.2], nodes: ['Drawer','DrawerHandle','Clue_operations','Clue_memo'], collider: [-1.1,-.65,1.1,.65], description: 'Metal workbench, drawer, tools, radio, operations book III—1 and desk memo ✕—3' },
